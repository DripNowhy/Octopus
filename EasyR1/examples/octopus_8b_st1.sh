...
# val_files="['$geo3k_val_path']"
MODEL_PATH=/scratch/gautschi/ding432/model/VLM/Qwen3-VL-8B-SFT-1223-lr1e-6/checkpoint-74  # replace it with your local file path
...
python3 -m verl.trainer.main \
    ...
    trainer.experiment_name=qwen3_vl_8b_octopus_stage1 \
    ...
    algorithm.kl_coef=0 \
    worker.actor.y1_kl_coef=0.01 \
    worker.rollout.training_stage=1 \
